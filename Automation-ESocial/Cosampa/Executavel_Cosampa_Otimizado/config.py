"""
Arquivo de configuração para o sistema Cosampa Energia Automation
Otimizado para execução sem privilégios de administrador
"""

import os

# Configurações do sistema - APENAS PASTAS DO USUÁRIO
...
# Configurações do Chrome - PASTAS DO USUÁRIO
...
# Configurações do ChromeDriver - PASTA DO USUÁRIO
...
JANELA_LARGURA = 400
JANELA_ALTURA = 450
JANELA_TITULO = "Cosampa Energia Automation - eSocial"
...
# Configurações de logs - PASTA DO USUÁRIO
LOG_DIR = os.path.join(os.path.expanduser("~"), "AppData", "Local", "CosampaLogs")
LOG_FILE = "cosampa_energia_automation.log"
